    ...
    <div class="experience-section">
        <div class="section-header">
            <div class="logo-container">
                <img alt="Razorbill" src="/res/razorbill.png" class="company-logo" />
            </div>
            <div class="section-info">
                <p class="section-title">Full-Stack Software Engineer</p>
                <p class="section-subtitle">Razorbill</p>
                <p class="section-date">December 2025 - Present</p>
            </div>
        </div>
        <div class="section-description">
            I'm building a fully automated multi-platform medical billing LLM agent that has already processed $20k+ worth of denied insurance claims.
        </div>
        <h3 class="section-accomplishments">Notable accomplishments:</h3>
        <ul>
            <li>Discovered and built out multiple major capability improvements to the agent</li>
            <li>Created a multi-tenant web app for practices to track and manage the billing agent's activity</li>
            <li>Meaningfully contributed across product, design, and GTM</li>
        </ul>
    </div>
    <div class="experience-section">
        <div class="section-header">
        ...
        <div class="section-description">
            I built a new web application enabling customers to visualize the costs of pay-as-you-go features in demo instances of the Salesforce platform, unlocking 20+ sales deals held up by hesitancy over costs. 
        </div>
        <h3 class="section-accomplishments">Notable accomplishments:</h3>
        <ul>
